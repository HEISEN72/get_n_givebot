...
MAIN_MENU_TEXT = (
    ...
    "Добро пожаловать в Get&Give! Я помогаю отслеживать графики и настроение рынка, а также уведомляю Вас об инетересующей паре в 8:00 UTC (европейская сессия).\n\n"
    "💡 *Как получить график?*\n"
